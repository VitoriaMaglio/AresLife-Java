...
@Tag(name = "Turistas Espaciais", description = "Gerenciamento de turistas espaciais")
    ...
    public ResponseEntity<List<TuristaEspacial>> listar(
    ...
    public ResponseEntity<TuristaEspacial> buscarPorId(@PathVariable Long id) {
    ...
    public ResponseEntity<TuristaEspacial> atualizarStatus(
    ...
    public ResponseEntity<TuristaEspacial> vincular(
            @PathVariable Long id,
